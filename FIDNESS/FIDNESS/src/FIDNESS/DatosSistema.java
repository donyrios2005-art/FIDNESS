...
public class DatosSistema {
    ...
    public static void inicializarDatos() {
        ...
        ejercicios.add(new Ejercicio("Fondos", "BRAZO", "Intermedio", "Ejercicio para tríceps y brazos."));
        ...
        ejercicios.add(new Ejercicio("Face pull", "HOMBRO", "Intermedio", "Ejercicio para hombro posterior."));
        ...
        ejercicios.add(new Ejercicio("Elevación de piernas", "ABDOMEN", "Intermedio", "Ejercicio para abdomen inferior."));
    }
